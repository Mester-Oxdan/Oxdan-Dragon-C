...
Enemy_1::Enemy_1(const float &x, const float &y)
    : Tank(x, y, 39, 39, "includes/own/includes/battle_city/media/enemySprites.png"), timeBeforeMoving(0.f), timeBeforeShot(0.f) {

    buffer_dead_4.loadFromFile("includes/own/includes/battle_city/media/fire.wav");
