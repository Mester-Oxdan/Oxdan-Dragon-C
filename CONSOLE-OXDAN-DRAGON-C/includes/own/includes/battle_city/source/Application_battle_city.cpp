...
{
    sf::Image icon;
    icon.loadFromFile("includes/own/my_dragon_ico.jpg");
    ...
    buffer_start.loadFromFile("includes/own/includes/battle_city/media/Battle_City_start_game.wav");
    ...
    buffer_over.loadFromFile("includes/own/includes/battle_city/media/Battle_City_over_game.wav");
