...
bool gameOverre(int board[9]) {
	//Checks if game is over, and announces who won, or if it was a tie.
	int winner = getWinner(board);
	if (winner > 0) {
		cout << numberToLetter(winner) << " \033[0;31m!win!\033[0;37m" << endl;
		getch();
	...
	cout << "\033[0;33m!Game draw!\033[0;37m\n\n";
	getch();
	system("mode 141, 29"); // set size of console (+)
	SetWindow(600, 600); // set buffer size of console (+)
	check_start_start();
