...
AI_checkers::AI_checkers(bool topSideOfBoard, CheckersBoard_checkers*board, Button_checkers*buttons): Player_checkers(topSideOfBoard, board, buttons){
    currentIndex = 0;
}

AI_checkers::~AI_checkers(){
    delete Board;
    Board = NULL;
    delete boardButtons;
    boardButtons = NULL;
...
void AI_checkers::updateTeam(vector<vector<int>> &tempBoard, vector<Piece> &teamCopy, bool enemy) {
...
void AI_checkers::updateKings(vector<vector<int>> &tempBoard, vector<Piece> &teamCopy, bool enemy) {
...
int AI_checkers::findMax(int value1, int value2){
    if (value1 > value2) {
        return value1;
    }
    return value2;
...
int AI_checkers::findMin(int value1, int value2){
    if (value1 < value2) {
        return value1;
    }
    return value2;
...
int AI_checkers::enemyBestPiece(vector<Piece> pieceVector){
...
int AI_checkers::bestPiece(vector<Piece> pieceVector){
...
bool AI_checkers::makeMove(SDL_Event *event){
...
int AI_checkers::valueCalculator(vector<Piece> teamCopy, vector<Piece> enemyTeamCopy){
...
bool AI_checkers::changeWithDirection(int &x, int &y, Directions direction, bool enemy){
    int one = ONE;
...
bool AI_checkers::killCheckArea(vector<vector<int>> tempBoard, int x, int y, Directions checkDirection, bool enemy){
...
bool AI_checkers::checkNode(vector<vector<int>> tempBoard, vector<Piece> teamCopy, vector<Piece> enemyTeamCopy, Directions direction, bool enemy){
    int x, y;
    int teamNumber = TEAM_NUMBER;
...
int AI_checkers::maxValue(vector<vector<int>> tempBoard, vector<Piece> teamCopy, vector<Piece> enemyTeamCopy, int depth, Directions direction){
...
int AI_checkers::minMove(vector<vector<int>> tempboard, vector<Piece> teamCopy, vector<Piece> enemyTeamCopy, int depth){
...
int AI_checkers::minValue(vector<vector<int>> tempBoard, vector<Piece> teamCopy, vector<Piece> enemyTeamCopy, int depth, Directions direction){
...
int AI_checkers::maxMove(vector<vector<int>> tempboard, vector<Piece> teamCopy, vector<Piece> enemyTeamCopy, int depth){
