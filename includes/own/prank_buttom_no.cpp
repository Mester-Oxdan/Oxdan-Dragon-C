...
#include <string.h>
#include <iostream>
#include "show_messagebox.h"

using namespace std;

string enter_question_go, enter_response_yes;

void main_question(string enter_question, string enter_response_yes)
{
    system("cls");

    if (IsWindowReady() == false)
    {
        main_question(enter_question, enter_response_yes);
    }
...
void prank_button_no()
{
    ...
    main_question(enter_question_go, enter_response_yes);
