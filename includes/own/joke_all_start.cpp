...
int joke_all_start(string name)
{
	try
	{
	if (name == "all" || name == "ALL" || name == "All")
	{
		...
		const char* folderPath = "memes/(+)All";
		...
		//std::cout << "Selected file: " << selectedFile << std::endl;
		string com_all = "start memes/(+)All/" + selectedFile_all;
		//com += selectedFile;
